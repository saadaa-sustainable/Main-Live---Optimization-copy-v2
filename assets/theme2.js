...
// console.log(window.customElements.get("image-with-text"));
...
if (true) {
  ...
  var CartCount = class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      document.addEventListener(
        "cart:refresh",
        __privateMethod(this, _updateFromServer, updateFromServer_fn).bind(
          this
        ),
        { signal: __privateGet(this, _abortController2).signal }
      );
  ...
  var LineItemQuantity = class extends HTMLElement {
    constructor() {
      ...
      __privateGet(this, _delegate).on(
        "change",
        "[data-line-key]",
        __privateMethod(this, _onQuantityChanged, onQuantityChanged_fn).bind(
          this
        )
      );
      __privateGet(this, _delegate).on(
...
if (windowUrl.includes("/collections")) {
...
if (windowUrl.includes("/collections")) {
  ...
  document.addEventListener("facet:update", async (event) => {
    ...
    const url = event.detail.url,
      ...
      // );
      shopifySection = document.getElementById(`collection_main_data`);
    const clonedUrl = new URL(url);
    console.log(shopifySection);
    ...
    try {
      ...
      shopifySection.replaceChildren(
        ...document.importNode(
          tempContent.querySelector("#collection_main_data"),
          true
        ).childNodes
      );
...
if (windowUrl.includes("/products")) {
  ...
  onVariantChanged_fn = function (event) {
    const addToCartButton = this.querySelector('button[type="submit"]'),
      ...
      notifyMeButtton = this.querySelector(".buy-buttons .notify___me");
    ...
    if (!event.detail.variant) {
      ...
      notifyMeButtton.style.display = event.detail.variant["available"]
        ? "none"
        : "block";
      if (paymentButton) {
  ...
  var VariantMedia = class extends HTMLElement {
    constructor() {
      ...
      __privateAdd(
        ...
        __privateMethod(this, _onVariantChanged2, onVariantChanged_fn2).bind(
          this
        )
      );
  ...
  var PaymentTerms = class extends HTMLElement {
    constructor() {
      ...
      __privateAdd(
        ...
        __privateMethod(this, _onVariantChanged3, onVariantChanged_fn3).bind(
          this
        )
      );
    }
  ...
  var PickupAvailability = class extends HTMLElement {
    constructor() {
      ...
      __privateAdd(
        ...
        __privateMethod(this, _onVariantChanged4, onVariantChanged_fn4).bind(
          this
        )
      );
    }
    ...
    async connectedCallback() {
      ...
      this.optionSelectors.forEach((optionSelector) => {
        optionSelector.addEventListener(
          "change",
          __privateMethod(this, _onOptionChanged, onOptionChanged_fn).bind(
            this
          ),
    ...
    selectVariant(id) {
      if (
        !__privateMethod(
          ...
          this,
          __privateMethod(this, _getVariantById, getVariantById_fn).call(
            this,
            id
          )
        )
      ...
      if (document.querySelector(".buy-buttons.floating")) {
        document
          .querySelector(".buy-buttons.floating")
          .closest("form").id.value = id;
      }
      if (document.querySelector(".notify___me")) {
        document.querySelector("#notify__text").dataset.variantid = id;
        document.querySelector(".notify_me_input").value =
          this.masterSelector.value;
      }
  ...
  updateDisableSelectors_fn = function () {
    ...
    const applyClassToSelector = (
      ...
      const optionInput = Array.from(
        selector.querySelectorAll("[data-option-input]")
      )[valueIndex];
  ...
  var CountdownTimer = class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      if (expiresAt !== "") {
        ...
        __privateMethod(this, _recalculateFlips, recalculateFlips_fn).call(
          this
        );
      }
      inView11(
...
if (windowUrl.includes("/collections") || windowUrl.includes("/products")) {
...
if (windowUrl.includes("/products")) {
  ...
  let notifyMeButtton = document.querySelector(".buy-buttons .notify___me");
  let x = 1;
  document.addEventListener("change", function (event) {
    if (x < 2 && sizeSelectorToggle) {
      ...
      notifyMeButtton.style.display = !event.target.className.includes(
        "is-disabled"
      )
        ? "none"
        : "block";
...
document
  .querySelector(".header_whatsapp")
  .addEventListener("click", openRPChatWidget);
